...
public class KompetensiSi extends AppCompatActivity {
    public static final String SEMESTER = "com.isneverdead.profilunisbank.SEMESTER";
    public static final String DATA_SEMESTER = "com.isneverdead.profilunisbank.DATA_SEMESTER";
    ...
    protected void onCreate( Bundle savedInstanceState) {
        ...
        listDosen.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent  = new Intent(view.getContext(), DaftarMataKuliahSi.class);
                intent.putExtra(SEMESTER, i+1);

                intent.putExtra(KODEMATKUL, "SI"+(i+1));
