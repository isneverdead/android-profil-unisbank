...
public class DaftarDosenTi extends AppCompatActivity {
    ...
    protected void onCreate( Bundle savedInstanceState) {
        ...
        String dosenList[] = {"Budi Hartono, S.Kom, M.Kom\n",
                "Dr. Aji Supriyanto, S.T, M.Kom\n" ,
                "Dr. Drs. Eri Zuliarso, M.Kom\n" ,
                "Dr. Edy Winarno, S.T., M.Eng\n" ,
                "Drs. Widiyanto Tri Handoko, M.Kom\n" ,
                ...
                "Rr. Dewi Handayani UN, S.Kom, M.Kom\n" ,
        ...
        listDosen.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                intent.putExtra(URL_FOTO_DOSEN, urlFotoDosen[i]);
